...
# Question 3
print("\n           Question 3\n")
# CONFIRM WHETHER ALL PARTS HAVE CORRECT BUILT IN FUNCTIONS
...
#print("The following values are greater than 4")
#for i in l:
    #if i>4:
        #print(i, end =" ")
...
# CONFIRM IF THIS METHOD CAN BE USED OR NEED TO USE ANAGRAMS METHOD
